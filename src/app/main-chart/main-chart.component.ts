...
export class MainChartComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.chart.chart = { height:350, type:"line"}
    this.chart.title = { text:"BROOKFIELD OFFICE CL AAA SRS W PRF", align:"left"}
    this.chart.stroke = { width:[3,1]},
    this.chart.series = [{
      name: "line",
      type: "line",
      data: [
    ...
    this.chart.tooltip = {shared: true, custom: [function({seriesIndex, dataPointIndex, w}) {
